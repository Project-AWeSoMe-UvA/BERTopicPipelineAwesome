...
# Only accessible for non-anonymized versions:
DOCS_VIDEO_PATH   = DOCUMENTS_DIR / "documents_with_topics_and_id.pkl"
...
# =============================================================================
# GRID SEARCH & SAMPLE SENSITIVITY FILES
# =============================================================================
...
SAMPLE_SENSITIVITY_PATH    = TOPIC_MODELLING_FILES_DIR / "sample_sensitivity_results.csv"
...
MERGED_INFO_CSV_PATH      = TOPIC_INFO_DIR / "merged_topic_info_final.csv"
...
# =============================================================================
# EXTERNAL DATA  (used in notebook 4)
# !! Supply your own data - these are anonymous and not publicly shared
# =============================================================================
LPA_PATH       = PROJECT_ROOT / "profiles.csv" # Latent Profile Analysis results
LANGUAGES_PATH = PROJECT_ROOT / "languages.csv" # Language per video ID